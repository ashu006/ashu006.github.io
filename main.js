...
var CustomerComponent = /** @class */ (function () {
    ...
    CustomerComponent.prototype.onSubmit = function () {
        var _this = this;
        this.submitted = true;
        if (this.customerService.form.valid && this.customerService.form.get('$key').value == null) {
...
var environment = {
    production: false,
    firebaseConfig: {
        apiKey: 'AIzaSyATJLLJ1M-VKyMh0VQu-KtNVyip_lEz31I',
        authDomain: 'userdetails-2cbf9.firebaseapp.com',
        databaseURL: 'https://userdetails-2cbf9.firebaseio.com',
        projectId: 'userdetails-2cbf9',
        storageBucket: 'userdetails-2cbf9.appspot.com',
        messagingSenderId: '147477138823'
    }
};
/*
...
module.exports = __webpack_require__(/*! F:\task\src\main.ts */"./src/main.ts");
